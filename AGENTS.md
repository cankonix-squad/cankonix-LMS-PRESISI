...
When continuing autonomously from this state, finish/review the active Admin task (`TASK-009` if present, otherwise `TASK-008`) first unless a user explicitly redirects the work.
