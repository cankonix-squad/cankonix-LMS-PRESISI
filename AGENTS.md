...
When continuing autonomously from this state, finish/review the active Admin task (`TASK-009E` if present, otherwise `TASK-009D`) first unless a user explicitly redirects the work.
