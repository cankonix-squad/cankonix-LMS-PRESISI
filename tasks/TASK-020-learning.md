...
`LearningMeeting`: id, classSubjectId, sequence, title, description, plannedStartAt nullable, plannedEndAt nullable, status; unique classSubject+sequence.

## API / Application Contract
CRUD/reorder/list meetings by classSubject.

## Business Rules
Meeting attach ke ClassSubject. Sequence deterministic. Published meeting tidak boleh hilang secara destruktif jika punya activity/progress.

## Acceptance Criteria
[ ] sequence unique; [ ] lifecycle; [ ] checks green.
