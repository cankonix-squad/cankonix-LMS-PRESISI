...
## Objective
Memisahkan definisi exam dari pelaksanaan dan eligibility.
...
`ExamSession`: examId, startAt, endAt, status, settings. `ExamParticipant`: sessionId, enrollmentId, status, accommodations JSON nullable; unique session+enrollment.

## API / Application Contract
Create/schedule/open/close session; assign participants; eligibility check endpoint/internal service.
