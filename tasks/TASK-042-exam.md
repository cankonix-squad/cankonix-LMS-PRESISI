...
## Objective
Mendefinisikan exam dan blueprint/randomization.
...
`Exam`: assessmentId unique, durationMinutes, attemptsAllowed, randomize flags, status. `ExamBlueprint`; `ExamBlueprintRule` with questionBank/topic/difficulty/count/points constraints.

## API / Application Contract
CRUD exam/blueprint; validate/publish configuration.
