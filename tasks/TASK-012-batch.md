...
## Objective
Membuat execution cohort dari program+curriculum.
...
`EducationBatch`: id, educationProgramId, curriculumId, code, name, startDate, endDate, status, capacity nullable, timestamps; unique program+code.

## API / Application Contract
CRUD/list batch; lifecycle/status; filter program/org/date.

## Business Rules
Batch wajib memakai curriculum milik program yang sama. endDate >= startDate. Curriculum reference frozen; perubahan curriculum master tidak mengganti batch.

## Acceptance Criteria
[ ] relation validation; [ ] date validation; [ ] lifecycle tested; [ ] checks green.
