...
export function SubmitButton({
  ...
  return (
    <button
      type="submit"
      disabled={disabled}
      className="w-full rounded-xl border border-sky-500/40 bg-sky-500/20 px-4 py-3 text-sm font-medium text-sky-100 transition hover:border-sky-400 hover:bg-sky-500/30 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
    >
      {children}
    </button>
  );
