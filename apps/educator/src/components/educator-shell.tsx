            ...
            {authenticated === false ? (
              <section className="rounded-lg border border-slate-200 bg-white p-8 text-center shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Data pengajaran hanya tersedia setelah sesi Educator aktif.
                </p>
                <a
                  href="/api/auth/login"
                  className="mt-5 inline-flex rounded-md bg-[#d6b46a] px-4 py-2 text-sm font-semibold text-[#172033] transition hover:bg-[#e4c679]"
                >
                  Masuk ke Portal Educator
                </a>
              </section>
            ) : authenticated === true ? (
              children
